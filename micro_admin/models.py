...
class User(AbstractBaseUser):
    ...
    user_roles = models.CharField(
        ...
        default=UserRoles.BRANCH_MANAGER,
    )
...
class Client(models.Model):
    ...
    gender = models.CharField(choices=GenderTypes.choices, max_length=1)
    client_role = models.CharField(choices=ClientRoles.choices, max_length=20)
    ...
    city = models.CharField(max_length=50)
    area = models.CharField(max_length=150)
    mobile = models.CharField(max_length=20, default='', null=True)
...
class ClientBranchTransfer(models.Model):
    client = models.ForeignKey(Client, related_name='client_name', on_delete=models.CASCADE)
    from_branch = models.ForeignKey(Branch, related_name='from_branch', on_delete=models.CASCADE)
    to_branch = models.ForeignKey(Branch, related_name='to_branch', on_delete=models.CASCADE)
    changed_on = models.DateTimeField(auto_now=True)
    changed_by = models.ForeignKey(User, related_name='changed_by', on_delete=models.CASCADE)

    def __str__(self):
        return f'{self.client.first_name} - from: {self.from_branch.name} - to: {self.to_branch.name}'


class Group(models.Model):
    name = models.CharField(max_length=200)
    code = models.CharField(max_length=100, default='DEFAULT_CODE')
    center = models.ForeignKey('Center', related_name='group_set',default=1, on_delete=models.CASCADE)
    created_by = models.ForeignKey(User, related_name="group_created_by", on_delete=models.CASCADE)
    account_number = models.CharField(max_length=50, unique=True)
    activation_date = models.DateField()
    is_active = models.BooleanField(default=True)
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE)
    staff = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE)
    clients = models.ManyToManyField(Client, through='GroupClient', blank=True)
...
class Center(models.Model):
    ...
    is_active = models.BooleanField(default=True)
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE)
    groups = models.ManyToManyField(Group, related_name='center_set', blank=True)
...
class GroupMeeting(models.Model):
    ...
    def __str__(self):
        return f'{self.group.name} {self.meeting_date}'
...
class SavingsAccount(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE)
    status = models.CharField(choices=AccountStatus.choices, max_length=20)
    opening_date = models.DateField()
...
class LoanAccount(models.Model):
    account_no = models.CharField(max_length=50, unique=True)
    interest_type = models.CharField(choices=InterestTypes.choices, max_length=20)
    ...
    loan_issued_by = models.ForeignKey(User, null=True, blank=True, related_name="loan_issued_by", on_delete=models.CASCADE)
...
class GroupMemberLoanAccount(models.Model):
    ...
    group_loan_account = models.ForeignKey(LoanAccount, on_delete=models.CASCADE)
    client = models.ForeignKey(Client, on_delete=models.CASCADE)
    loan_amount = models.DecimalField(max_digits=19, decimal_places=6)
    loan_repayment_period = models.IntegerField()
    loan_repayment_every = models.IntegerField()
...
class FixedDeposits(models.Model):
    ...
    status = models.CharField(choices=FdRdStatus.choices, max_length=20)
    ...
    nominee_gender = models.CharField(choices=GenderTypes.choices, max_length=10)
...
class Receipts(models.Model):
    ...
    client = models.ForeignKey(Client, on_delete=models.CASCADE, null=True, blank=True)
    group = models.ForeignKey(Group, on_delete=models.CASCADE, null=True, blank=True, default=0)
    member_loan_account = models.ForeignKey(LoanAccount, on_delete=models.CASCADE, null=True, blank=True)
    group_loan_account = models.ForeignKey(LoanAccount, on_delete=models.CASCADE, null=True, blank=True, related_name="group_loan_account")
    ...
    fixed_deposit_account = models.ForeignKey(FixedDeposits, on_delete=models.CASCADE, related_name='reciept_fixed_deposit', blank=True, null=True)
    fixeddeposit_amount = models.DecimalField(max_digits=19, decimal_places=6, null=True, blank=True, default=0)
    recurring_deposit_account = models.ForeignKey(RecurringDeposits, on_delete=models.CASCADE, related_name='reciept_recurring_deposit', blank=True, null=True)
...
class Payments(models.Model):
    ...
    payment_type = models.CharField(choices=PaymentTypes.choices, max_length=25)
    ...
    loan_account = models.ForeignKey(LoanAccount, on_delete=models.CASCADE, related_name='payment_loanaccount', blank=True, null=True)
    fixed_deposit_account = models.ForeignKey(FixedDeposits, on_delete=models.CASCADE, related_name='payment_fixed_deposit', blank=True, null=True)
    recurring_deposit_account = models.ForeignKey(RecurringDeposits, on_delete=models.CASCADE, related_name='payment_recurring_deposit', blank=True, null=True)
