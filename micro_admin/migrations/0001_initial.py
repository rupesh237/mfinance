# Generated by Django 4.2.14 on 2024-07-21 07:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_role', models.CharField(choices=[('FirstLeader', 'First Leader'), ('SecondLeader', 'Second Leader'), ('GroupMember', 'Group Member')], max_length=20)),
                ...
                ('city', models.CharField(max_length=50)),
                ('area', models.CharField(max_length=150)),
                ('mobile', models.CharField(default='', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Opened', 'Opened'), ('Paid', 'Paid'), ('Closed', 'Closed')], max_length=20)),
                ...
                ('nominee_photo', models.ImageField(upload_to='users/')),
                ('nominee_signature', models.ImageField(upload_to='signatures/')),
                ...
                ('total_withdrawal_amount_principle', models.DecimalField(blank=True, decimal_places=6, max_digits=19, null=True)),
                ('total_withdrawal_amount_interest', models.DecimalField(blank=True, decimal_places=6, max_digits=19, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='DEFAULT_CODE', max_length=100)),
                ('account_number', models.CharField(max_length=50, unique=True)),
                ('activation_date', models.DateField()),
                ('is_active', models.BooleanField(default=True)),
                ('status', models.CharField(default='UnAssigned', max_length=50)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='micro_admin.branch')),
                ('center', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='group_set', to='micro_admin.center')),
            ],
        ),
        migrations.CreateModel(
            name='LoanAccount',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_roles', models.CharField(choices=[('BranchManager', 'Branch Manager'), ('LoanOfficer', 'Loan Officer'), ('Cashier', 'Cashier')], default='BranchManager', max_length=20)),
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.branch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.client')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='micro_admin.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_withdrawal_amount_principle', models.DecimalField(blank=True, decimal_places=6, max_digits=19, null=True)),
                ('total_withdrawal_amount_interest', models.DecimalField(blank=True, decimal_places=6, max_digits=19, null=True)),
                ('number_of_payments', models.PositiveIntegerField(blank=True, default=0, null=True)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='micro_admin.client')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='micro_admin.branch')),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.client')),
                ('fixed_deposit_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reciept_fixed_deposit', to='micro_admin.fixeddeposits')),
                ...
                ('recurring_deposit_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reciept_recurring_deposit', to='micro_admin.recurringdeposits')),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='micro_admin.user')),
            ],
        ),
        migrations.CreateModel(
            name='Payments',
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('Loans', 'Loans'), ('TravellingAllowance', 'Travelling Allowance'), ('PaymentOfSalary', 'Payment of Salary'), ('PrintingCharges', 'Printing Charges'), ('StationaryCharges', 'Stationary Charges'), ('OtherCharges', 'Other Charges'), ('SavingsWithdrawal', 'Savings Withdrawal'), ('FixedWithdrawal', 'Fixed Deposit Withdrawal'), ('RecurringWithdrawal', 'Recurring Deposit Withdrawal')], max_length=25)),
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='micro_admin.branch')),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.client')),
                ('fixed_deposit_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_fixed_deposit', to='micro_admin.fixeddeposits')),
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.group')),
                ('loan_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_loanaccount', to='micro_admin.loanaccount')),
                ('recurring_deposit_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_recurring_deposit', to='micro_admin.recurringdeposits')),
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.user')),
            ],
        ),
        migrations.AddField(
            model_name='loanaccount',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='micro_admin.user'),
        ),
        migrations.AddField(
            model_name='loanaccount',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.group'),
        ),
        migrations.AddField(
            model_name='loanaccount',
            name='loan_issued_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='loan_issued_by', to='micro_admin.user'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='group',
            name='clients',
            field=models.ManyToManyField(blank=True, through='micro_admin.GroupClient', to='micro_admin.client'),
        ),
        migrations.AddField(
            model_name='group',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_created_by', to='micro_admin.user'),
        ),
        migrations.AddField(
            model_name='group',
            name='staff',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='micro_admin.user'),
        ),
        migrations.CreateModel(
            name='ClientBranchTransfer',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('changed_on', models.DateTimeField(auto_now=True)),
                ('changed_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='changed_by', to='micro_admin.user')),
        ...
        migrations.AddField(
            model_name='center',
            name='groups',
            field=models.ManyToManyField(blank=True, related_name='center_set', to='micro_admin.group'),
        ),
    ]
